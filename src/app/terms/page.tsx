    ...
    <div className="min-h-screen">
      ...
      <section className="py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-neutral">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">By accessing and using LaveterPrise, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you should not use our website or services.</p>
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">All content on LaveterPrise, including text, images, logos, and design, is our intellectual property or used with permission. You may not reproduce or distribute any content without written consent.</p>

          <h2 className="text-xl font-bold mt-8 mb-3">8. Limitation of Liability</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">LaveterPrise is not liable for any indirect, incidental, or consequential damages arising from your use of our website or products. Our total liability shall not exceed the amount paid by you for the product.</p>

          <h2 className="text-xl font-bold mt-8 mb-3">9. Contact</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">For questions about these terms, contact us at legal@laventerprise.com or through our contact page.</p>
        </div>
      </section>
    </div>
  );
